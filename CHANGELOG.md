...
## [1.5.6](https://github.com/Feng-H/VTS-silliconflow/releases/tag/v1.5.6) (2026-02-23)

### Features

* **Status Bar Refinement**: Redesigned status bar icons to feature only the core "Waveform" from the logo. Added distinct red (recording) and blue (processing) states.

## [1.5.5](https://github.com/Feng-H/VTS-silliconflow/releases/tag/v1.5.5) (2026-02-23)

### Features

* **Status Bar Branding**: Automatically generated monochromatic status bar icons from new logo for seamless system integration.

## [1.5.4](https://github.com/Feng-H/VTS-silliconflow/releases/tag/v1.5.4) (2026-02-23)

### Features

* **One-Click Permission Fix**: Added a powerful reset button to fix accessibility permissions that get stuck after app updates.
* **Simplified UI**: Streamlined the accessibility setup process to be much more user-friendly.
...
* **Brand Update**: Replaced app icons and logo with new custom branding to establish independent identity.
